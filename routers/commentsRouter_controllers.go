...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/presupuesto_crud/controllers:RubroHomologadoController"] = append(beego.GlobalControllerRouter["github.com/udistrital/presupuesto_crud/controllers:RubroHomologadoController"],
        beego.ControllerComments{
            Method: "Post",
            Router: `/`,
            AllowHTTPMethods: []string{"post"},
    ...
    beego.GlobalControllerRouter["github.com/udistrital/presupuesto_crud/controllers:RubroHomologadoRubroController"] = append(beego.GlobalControllerRouter["github.com/udistrital/presupuesto_crud/controllers:RubroHomologadoRubroController"],
        beego.ControllerComments{
            Method: "Post",
            Router: `/`,
            AllowHTTPMethods: []string{"post"},
